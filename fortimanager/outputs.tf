...
# output "vm_disk_type" {
#   description = "Disk type used for OS and data disks."
#   value       = azurerm_linux_virtual_machine.main.custom_data
# }
#output does not exist therefore commenting out.
...
#   name                = azurerm_linux_virtual_machine.main.os_disk[0].name
